...
using EFCodeOnlyFromDB.Models;
using Microsoft.EntityFrameworkCore;

namespace EFCodeOnlyFromDB.Entities;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=localhost\\MSSQLSERVER01;Initial Catalog=ITI;User ID=MennaMagdy;Password=Menna5684@noone;TrustServerCertificate=True");
        //=> optionsBuilder.UseSqlServer("Data Source=localhost\\MSSQLSERVER01;Initial Catalog=ITI;Persist Security Info=True;User ID=MennaMagdy;Password=Menna5684@noone;Encrypt=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("Department", tb => tb.HasTrigger("T1"));

            entity.Property(e => e.Dept_Id).ValueGeneratedNever();

            entity.HasOne(d => d.Dept_ManagerNavigation).WithOne(p => p.Department).HasConstraintName("FK_Department_Instructor");
        });
